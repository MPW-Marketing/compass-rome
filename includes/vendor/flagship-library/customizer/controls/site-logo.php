...
class Flagship_Site_Logo_Image_Control extends WP_Customize_Control {
	...
	public function __construct( $wp_customize, $control_id, $args = array() ) {
		...
		$this->l10n = array(
			'upload'      => __( 'Add logo',    'compassrome-mpw-rome' ),
			'set'         => __( 'Set as logo', 'compassrome-mpw-rome' ),
			'choose'      => __( 'Choose logo', 'compassrome-mpw-rome' ),
			'change'      => __( 'Change logo', 'compassrome-mpw-rome' ),
			'remove'      => __( 'Remove logo', 'compassrome-mpw-rome' ),
			'placeholder' => __( 'No logo set', 'compassrome-mpw-rome' ),
		);
