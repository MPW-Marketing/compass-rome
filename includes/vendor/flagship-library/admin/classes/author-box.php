...
class Flagship_Author_Box_Admin {
	...
	public function user_contactmethods( array $contactmethods ) {
		$contactmethods['googleplus'] = __( 'Google+', 'compassrome-mpw-rome' );
		$contactmethods['twitter']    = __( 'Twitter (Without @)', 'compassrome-mpw-rome' );
		$contactmethods['facebook']   = __( 'Facebook', 'compassrome-mpw-rome' );
