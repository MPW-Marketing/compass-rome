...
function flagship_tiny_mce_formats( $args ) {
	$flagship_formats = apply_filters( 'flagship_tiny_mce_formats',
		array(
			array(
				'title'    => __( 'Drop Cap', 'compassrome-mpw-rome' ),
				'inline'   => 'span',
				'classes'  => 'dropcap',
			),
			array(
				'title'    => __( 'Pull Quote Left', 'compassrome-mpw-rome' ),
				'block'    => 'blockquote',
				'classes'  => 'pullquote alignleft',
				'wrapper'  => true,
			),
			array(
				'title'    => __( 'Pull Quote Right', 'compassrome-mpw-rome' ),
				'block'    => 'blockquote',
				'classes'  => 'pullquote alignright',
				'wrapper'  => true,
			),
			array(
				'title'    => __( 'Intro Paragraph', 'compassrome-mpw-rome' ),
				'selector' => 'p',
				'classes'  => 'intro-pagragraph',
				'wrapper'  => true,
			),
			array(
				'title'    => __( 'Call to Action', 'compassrome-mpw-rome' ),
				'block'    => 'div',
			...
			array(
				'title'    => __( 'Feature Box', 'compassrome-mpw-rome' ),
				'block'    => 'div',
				'classes'  => 'feature-box',
				'wrapper'  => true,
				'exact'    => true,
			...
			array(
				'title'    => __( 'Code Block', 'compassrome-mpw-rome' ),
				'format'   => 'pre',
			),
			array(
				'title'    => __( 'Buttons', 'compassrome-mpw-rome' ),
				'items'    => array(
					array(
						'title'    => __( 'Standard', 'compassrome-mpw-rome' ),
						'selector' => 'a',
						'classes'  => 'button',
						'exact'    => true,
					),
					array(
						'title'    => __( 'Standard Block', 'compassrome-mpw-rome' ),
						'selector' => 'a',
					...
					array(
						'title'    => __( 'Call to Action Block', 'compassrome-mpw-rome' ),
						'selector' => 'a',
