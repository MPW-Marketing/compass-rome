...
<section <?php hybrid_attr( 'author-box', 'single' ); ?>>
	...
	<div class="author-info">
		...
		<h3 class="author-box-title">
			<?php _e( 'Written by', 'compassrome-mpw-rome' ); ?> <?php the_author_posts_link(); ?>
		</h3>
	...
	<ul class="social-icons">
		...
		<li class="social-twitter">
			<a href="<?php echo esc_url( "https://twitter.com/{$twitter}" ); ?>">
				<span class="text"><?php _e( 'Twitter', 'compassrome-mpw-rome' ); ?></span>
			</a>
		</li>
		<?php endif; ?>
		...
		<li class="social-gplus">
			<a href="<?php echo esc_url( $gplus ); ?>">
				<span class="text"><?php _e( 'Google+', 'compassrome-mpw-rome' ); ?></span>
			</a>
		</li>
		<?php endif; ?>
		...
		<li class="social-facebook">
			<a href="<?php echo esc_url( $facebook ); ?>">
				<span class="text"><?php _e( 'Facebook', 'compassrome-mpw-rome' ); ?></span>
			</a>
		</li>
		<?php endif; ?>
		...
		<li class="social-rss">
			<a href="<?php echo esc_url( get_author_feed_link() ); ?>">
				<span class="text"><?php _e( 'RSS Feed', 'compassrome-mpw-rome' ); ?></span>
			</a>
		</li>
